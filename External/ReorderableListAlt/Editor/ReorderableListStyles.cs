...
using Framework.EditorTools.ReorderableList.Internal;
using UnityEditor;
using UnityEngine;

namespace Framework.EditorTools.ReorderableList
{
    /// <summary>
    ...
    public static class ReorderableListStyles
    {
        ...
        /// <summary>
        /// The background color used by the editor skins.
        /// </summary>
        public static Color BackgroundColor => EditorGUIUtility.isProSkin ? new Color32(100, 100, 100, 255) : new Color32(220, 220, 220, 255);
